        ...
        <div class="p-5">
          ...
          <?php 
            ...
            if(isset($_POST['addslider'])){
              ...
              $photo = $_FILES['slider']['name'];
              $tmp_name = $_FILES['slider']['tmp_name'];
              
              $upload_path = 'img/slider_img/';
              ...
              $photo_full_name = $upload_path.$photo;
                ...
                $sql = "INSERT INTO sliders (slider_path) VALUES ('$photo_full_name')";
          ...
          <div class="form-group">
            <input type="file" name="slider" class="form-control form-control-user" placeholder="add a slider">
          </div>
          <button name="addslider" class="btn btn-primary btn-user btn-block" type="submit">
            Save slider
          </button> 
          </form>
